...
public enum NabtoStatus {
    ...
    INVALID_STREAM_OPTION,  ///< Invalid stream option.
    INVALID_STREAM_OPTION_ARGUMENT, ///< Invalid stream option argument
    ...
    public static NabtoStatus fromInteger(int nabtoStatus) {
